...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('text-base md:text-lg [&_tr]:border-b-gray-400', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-6 text-left align-middle font-medium text-gray-500 dark:text-gray-400 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
