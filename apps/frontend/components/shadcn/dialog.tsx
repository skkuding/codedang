...
>(({ className, showDarkOverlay = false, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'backdrop-blur-xs fixed inset-0 z-50 bg-gray-100/60 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 dark:bg-gray-950/60',
      className,
      {
