...
import { NavLink } from '@/app/(client)/(main)/_components/NavLink'
...
export function SignUpHeader() {
  ...
  return (
    <header className="backdrop-blur-xs fixed left-0 z-40 grid h-[60px] w-full place-items-center bg-white px-5 lg:px-[30px]">
