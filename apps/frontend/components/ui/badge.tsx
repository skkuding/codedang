  ...
  'inline-flex items-center rounded-full border border-gray-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 dark:border-gray-800 dark:focus:ring-gray-300',
  {
    variants: {
      variant: {
        ...
        level1: 'bg-level-bg-1 text-level-text-1',
        level2: 'bg-level-bg-2 text-level-text-2',
        level3: 'bg-level-bg-3 text-level-text-3',
        level4: 'bg-level-bg-4 text-level-text-4',
        level5: 'bg-level-bg-5 text-level-text-5'
      }
    },
    defaultVariants: {
      variant: 'default'
