...
import { createSchema } from '../../../assignment/_libs/schemas'
import type { AssignmentProblem } from '../../../assignment/_libs/type'
import { isOptionAfterDeadline } from '../../../assignment/_libs/utils'
...
export function CreateExerciseForm({
  ...
  const onSubmit = async () => {
    ...
    router.push(`/admin/course/${groupId}/exercise` as const)
    router.refresh()
  }
