      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <div className="flex flex-col gap-[15px]">
          <Textarea
            value={text}
            id="textarea"
            className="placeholder:text-color-neutral-90 text-body3_r_16 min-h-[120px] resize-none whitespace-pre-wrap rounded-none border-none p-0 shadow-none focus-visible:ring-0"
