    ...
    <div className="flex flex-row space-x-6">
      {isTalkBalloon ? (
        <div className="flex flex-col items-center justify-center">
          <div className="text-sub3_sb_16 relative mt-[9px] flex h-[33px] w-[70px] flex-row items-center justify-center rounded-full bg-[#3581FA] text-white">
            {title}
        ...
        <p
          className="text-title1_sb_20 mt-[9px] flex h-[50px] w-[70px] flex-row items-center justify-center rounded-[10px] bg-[#FAFAFA]"
      ...
      <div className="flex h-[68px] w-[491px] flex-col justify-center rounded-[10px] bg-[#FAFAFA] pl-6">
        <p className="text-sub3_sb_16 h-[22px] w-[100px] text-[#474747]">
          {explanationTitle}
        </p>
        {explanationDetail && (
          <p className="text-body4_r_14 text-[#737373]">{explanationDetail}</p>
        )}
      </div>
    </div>
  )
            ...
            <div className="flex text-[#5C5C5C]">
              ...
              <div className="ml-4 flex flex-col space-y-4">
                ...
                <div className="flex h-[104px] w-[562px] flex-col gap-3 rounded-[10px] bg-[#80808014] py-[18px] pl-6 pr-[69px] text-[#737373]">
                  <p className="text-body4_r_14 h-4 text-black">
