    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-3">
                ...
                <tr className="text-gray-500">
                  <td className="bg-primary-light flex w-[80px] flex-col items-center rounded-bl-md px-2 py-2 text-xs text-white">
                    ...
                    {assignmentProblemRecord.autoFinalizeScore && (
                      <span className="text-primary shadow-xs mt-1 rounded-full bg-white px-2 py-0.5 text-[10px] font-medium">
                        Auto
                      </span>
                    )}
                  </td>
          ...
          <div className="-ml-9 flex h-[281px] w-[600px] flex-col items-center rounded-sm">
