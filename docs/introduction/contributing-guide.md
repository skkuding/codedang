# Contributing Guide
SKKUDING에 contribution 해주셔서 감사합니다! 이 글은 contribute 시 따라야 할 지침을 설명합니다. 
...
> 3. Container image가 자동으로 build되고 미리 설정된 확장, 명령어 및 설정이 자동으로 구성됩니다. 처음 구성 시작 image를 새로 받아 build하므로 5 ~ 10분 정도의 시간이 걸릴 수 있습니다.

만약 위와 같은 환경을 구성하기 어렵다면, [Gitpod](https://gitpod.io/#https://github.com/skkuding/next)을 대신 사용할 수 있습니다.

개발 환경 설정에 대한 자세한 내용이 알고싶다면 [Getting Started](/introduction/getting-started) 페이지를 참고해주세요!
